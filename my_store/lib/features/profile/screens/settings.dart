            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: MySizes.spaceBtwItems,),
                  SettingsMenuTile(icon: Iconsax.document_upload, title: 'Load Data', subtitle: 'Upload Data.', onTap: () {},),
                  SettingsMenuTile(icon: Iconsax.location, title: 'Location', subtitle: 'Set recommendations based on location.', trailing: Switch(value: true, onChanged: (value) {},),),
